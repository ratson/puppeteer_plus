...
import * as os from "https://deno.land/std@0.135.0/node/os.ts";
import * as fs from "https://deno.land/std@0.135.0/node/fs.ts";
import * as path from "https://deno.land/std@0.135.0/node/path.ts";
import * as util from "https://deno.land/std@0.135.0/node/util.ts";
...
import { copy } from "https://deno.land/std@0.135.0/fs/copy.ts";
import { copy as copyIO } from "https://deno.land/std@0.135.0/streams/conversion.ts";
