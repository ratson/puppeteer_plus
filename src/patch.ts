import { Browser, Page } from "npm:puppeteer-core@22.7.1";
import { importFSPromises } from "npm:puppeteer-core@22.7.1/internal/common/util.js";
...
declare module "npm:puppeteer-core@22.7.1" {
  interface Browser {
