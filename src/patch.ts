import { Browser, Page } from "npm:puppeteer-core@22.6.4";
import { importFSPromises } from "npm:puppeteer-core@22.6.4/internal/common/util.js";
...
declare module "npm:puppeteer-core@22.6.4" {
  interface Browser {
