import { Browser, Page } from "npm:puppeteer-core@21.6.1";
import { importFSPromises } from "npm:puppeteer-core@21.6.1/internal/common/util.js";
...
declare module "npm:puppeteer-core@21.6.1" {
  interface Browser {
