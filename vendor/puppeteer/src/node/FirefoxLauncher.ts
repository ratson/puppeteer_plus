...
import fs from 'https://deno.land/std@0.149.0/node/fs.ts';
import os from 'https://deno.land/std@0.149.0/node/os.ts';
import path from 'https://deno.land/std@0.149.0/node/path.ts';
...
import {ProductLauncher, resolveExecutablePath} from './ProductLauncher.ts';
