import { basename } from "https://deno.land/std@0.217.0/path/basename.ts";
import { download, type DownloadOptions as DownloadOptions_ } from "https://deno.land/x/yxz@0.28.0/net/download.ts";
